...
├── AI_logic_app/
│   ├── AI_logic.py        # Core AI logic and functions
│   ├── data/
│   │   ├── cuby.json      # Intent patterns and responses
│   │   ├── songs/         # Local song files
│   │   ├── screenshots/   # Captured screenshots
│   │   └── remember/      # Stored information
│   └── ...
...
Made with ❤️ for voice-controlled automation enthusiasts
